...
module.exports = JSON.parse("{\"id\":\"6f6e8c4a-0c93-4daf-cddb-4db528cb7147\",\"author\":\"\",\"widgets\":[{\"id\":\"uxp_showcase\",\"title\":\"uxp_showcase\",\"description\":\"A sample widget\"}],\"sidebarLinks\":[{\"id\":\"uxp_showcaseLink\"}]}");
...
// Module
exports.push([module.i, ".uxp-showcase-container {\n  width: 100%;\n  height: 100%;\n  margin: 0;\n  padding: 0;\n  display: flex;\n  align-content: stretch;\n  flex-wrap: nowrap;\n  position: relative;\n  overflow: hidden;\n  background-color: #ffffff; }\n  .uxp-showcase-container .sidebar-container {\n    flex-basis: 12%;\n    background-color: #ffffff;\n    height: 100%;\n    overflow: auto; }\n    .uxp-showcase-container .sidebar-container::-webkit-scrollbar {\n      width: 1px !important; }\n    .uxp-showcase-container .sidebar-container ul.sidebar {\n      list-style: none;\n      max-height: 100%;\n      overflow-y: auto;\n      margin: 0; }\n      .uxp-showcase-container .sidebar-container ul.sidebar li {\n        display: block;\n        width: 100%;\n        margin: 0;\n        padding: 10px 6px 10px 20px;\n        box-sizing: border-box;\n        border-top: 1px solid transparent;\n        border-bottom: 1px solid transparent;\n        text-transform: capitalize;\n        cursor: pointer;\n        position: relative; }\n        .uxp-showcase-container .sidebar-container ul.sidebar li:before {\n          content: \"\";\n          position: absolute;\n          width: 4px;\n          height: 1px;\n          background-color: #424242;\n          top: 50%;\n          left: 10px;\n          transform: translateY(-50%); }\n        .uxp-showcase-container .sidebar-container ul.sidebar li:hover {\n          border-top: 1px solid rgba(0, 0, 0, 0.12);\n          border-bottom: 1px solid rgba(0, 0, 0, 0.12); }\n        .uxp-showcase-container .sidebar-container ul.sidebar li.section {\n          padding-left: 0; }\n          .uxp-showcase-container .sidebar-container ul.sidebar li.section:before {\n            display: none; }\n          .uxp-showcase-container .sidebar-container ul.sidebar li.section:hover {\n            border-top: 1px solid transparent;\n            border-bottom: 1px solid transparent; }\n        .uxp-showcase-container .sidebar-container ul.sidebar li a {\n          text-decoration: none; }\n  .uxp-showcase-container .content {\n    flex-basis: 88%;\n    height: 100%;\n    overflow: auto; }\n    .uxp-showcase-container .content .uxp-showcase {\n      width: auto;\n      height: auto;\n      margin: 0;\n      padding: 20px; }\n      .uxp-showcase-container .content .uxp-showcase .showcase-section {\n        width: auto;\n        height: auto;\n        margin: 20px;\n        box-sizing: border-box;\n        display: flex;\n        flex-direction: column; }\n        .uxp-showcase-container .content .uxp-showcase .showcase-section.inline {\n          display: inline-flex; }\n        .uxp-showcase-container .content .uxp-showcase .showcase-section.bgWhite {\n          background-color: white;\n          padding: 10px; }\n        .uxp-showcase-container .content .uxp-showcase .showcase-section .example {\n          width: auto;\n          min-width: 200px;\n          border-radius: 10px;\n          margin: 5px;\n          box-sizing: border-box;\n          height: 90%; }\n        .uxp-showcase-container .content .uxp-showcase .showcase-section#filter-panel {\n          padding: 15px; }\n", ""]);
// Exports
...
/***/ "./src/components/ToolTipExample.tsx":
/*!*******************************************!*\
  !*** ./src/components/ToolTipExample.tsx ***!
  \*******************************************/
/*! no static exports found */
...
const ToolTipExample = (props) => {
    return (React.createElement("div", { className: "section" },
        ...
        React.createElement("div", { className: "showcase-section inline bgWhite", id: "modal" },
            React.createElement("h4", null, "Tooltip (top)"),
            React.createElement("div", { className: "example" },
                React.createElement(components_1.Tooltip, { content: "Tooltip on top" },
                    React.createElement(components_1.Button, { onClick: () => { }, title: "Hover me" })))),
        React.createElement("div", { className: "showcase-section inline bgWhite", id: "modal" },
            React.createElement("h4", null, "Tooltip (bottom)"),
            React.createElement("div", { className: "example" },
                React.createElement(components_1.Tooltip, { content: "Tooltip on bottom", position: "bottom" },
                    React.createElement(components_1.Button, { onClick: () => { }, title: "Hover me" })))),
        React.createElement("div", { className: "showcase-section inline bgWhite", id: "modal" },
            React.createElement("h4", null, "Tooltip (left)"),
            React.createElement("div", { className: "example" },
                React.createElement(components_1.Tooltip, { content: "Tooltip on left", position: "left" },
                    React.createElement(components_1.Button, { onClick: () => { }, title: "Hover me" })))),
        React.createElement("div", { className: "showcase-section inline bgWhite", id: "modal" },
            React.createElement("h4", null, "Tooltip (right)"),
            React.createElement("div", { className: "example" },
                React.createElement(components_1.Tooltip, { content: "Tooltip on right", position: "right" },
                    React.createElement(components_1.Button, { onClick: () => { }, title: "Hover me" }))))));
};
...
const React = __importStar(__webpack_require__(/*! react */ "react"));
const Welcome = (props) => {
    return React.createElement("div", { className: "welcome-block" },
        React.createElement("h2", null, " EXPERIENCE DASHBOARD - SHOWCASE "));
};
...
const ToolTipExample_1 = __importDefault(__webpack_require__(/*! ./components/ToolTipExample */ "./src/components/ToolTipExample.tsx"));
const Welcome_1 = __importDefault(__webpack_require__(/*! ./components/Welcome */ "./src/components/Welcome.tsx"));
const UXPShowcase = (props) => {
    let _sections = [
    ...
    // states
    let [sections, setSections] = React.useState(_sections);
    let [sidebarContent, setSidebarContent] = React.useState(_sidebarContent);
    const renderSidebarItems = (section) => {
        let _links = sidebarContent.filter((sidebarItem) => sidebarItem.section == section);
        return React.createElement(React.Fragment, null, _links.map((link, key) => {
            return React.createElement("li", { key: key },
                " ",
                React.createElement(react_router_dom_1.Link, { to: link.link }, link.label));
        }));
    };
    const renderSidebar = () => {
        return React.createElement("ul", { className: "sidebar" }, sections.map((section, key) => {
            return React.createElement(React.Fragment, null,
                React.createElement("li", { className: "section", key: key },
                    " ",
                    section.label,
                    " "),
    ...
    return (React.createElement("div", { className: "uxp-showcase-container" },
        React.createElement(react_router_dom_1.HashRouter, null,
            React.createElement("div", { className: "sidebar-container" }, renderSidebar()),
            React.createElement("div", { className: "content" },
                React.createElement("div", { className: "uxp-showcase" },
                    React.createElement(react_router_dom_1.Switch, null,
                        React.createElement(react_router_dom_1.Route, { exact: true, path: "/", component: Welcome_1.default }),
                        React.createElement(react_router_dom_1.Route, { exact: true, path: "/tooltip", component: ToolTipExample_1.default })))))));
};
uxp_1.registerUI({
    id: "uxp-showcase",
